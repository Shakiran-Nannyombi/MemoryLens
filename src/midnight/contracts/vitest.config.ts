 ...
 *
 * Run with:
 *   NODE_OPTIONS='--experimental-vm-modules' npx vitest run --config src/midnight/contracts/vitest.config.ts
 *
 * Or add to package.json scripts:
 *   "test:contract": "NODE_OPTIONS='--experimental-vm-modules' vitest run --config src/midnight/contracts/vitest.config.ts"
 */
export default defineConfig({
  test: {
    ...
    include:     ['src/midnight/contracts/**/*.test.ts'],
    reporters:   ['default'],
